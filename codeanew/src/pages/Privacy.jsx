      ...
      <section className="pt-0 pb-20 bg-white">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="mb-8 text-muted leading-relaxed">
            Welcome to codeanew, based in Sharjah, UAE. We value your privacy
          ...
          <Section number="1" title="Information We Collect">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted">
              ...
              <li>
                <strong className="text-heading">Technical Information:</strong>{" "}
                IP address, browser type, and operating system collected through
                cookies.
              </li>
              <li>
                <strong className="text-heading">Usage Data:</strong> Pages
                visited, links clicked, and time spent on our site.
              </li>
            </ul>
          </Section>
          ...
          <Section number="2" title="How We Use Your Information">
            <ul className="list-disc list-inside space-y-2 text-muted">
              ...
              <li>
                Send promotional offers and newsletters, subject to your
                consent.
              </li>
              <li>
          ...
          <Section number="3" title="Sharing Your Information">
            ...
            <ul className="list-disc list-inside space-y-2 text-muted">
              <li>
                <strong className="text-heading">Service Providers:</strong>{" "}
                Third-party companies assisting in running our business.
              </li>
              <li>
                <strong className="text-heading">Legal Obligations:</strong>{" "}
                Relevant government authorities when required by UAE laws.
              </li>
            </ul>
          </Section>
          ...
          <Section number="4" title="Data Security">
            <p className="text-muted">
              ...
              measures to safeguard your personal information. However, no data
          ...
          <Section number="6" title="Cookies">
            <p className="text-muted">
              ...
              your experience. We also use HubSpot, a third-party customer
              communication tool, which may collect data such as your IP
              address, browser type, and pages visited to provide chat support
              and improve our services. You can adjust your browser settings to
              decline cookies, though this may affect functionality.
            </p>
          </Section>
          ...
          <Section number="9" title="Contact Us">
            <div className="bg-bg-light rounded-xl p-5 text-sm text-muted space-y-1">
              ...
              <p className="m-0">
                <strong className="text-heading">Address:</strong> {company.address}
              </p>
            </div>
          </Section>
        </div>
