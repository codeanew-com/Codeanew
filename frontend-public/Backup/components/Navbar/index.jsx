            ...
            <div>
              ...
              {companyOpen && (
                <div className="pl-6 flex flex-col border-l-2 border-gold ml-4 mb-1">
                  <RouterLink to="/about"       className="py-2 text-sm text-gray-600 hover:text-gold transition-colors" onClick={handleScrollToTop}>About Us</RouterLink>
                  <RouterLink to="/our-process" className="py-2 text-sm text-gray-600 hover:text-gold transition-colors" onClick={handleScrollToTop}>Our Process</RouterLink>
                </div>
              )}
            </div>
